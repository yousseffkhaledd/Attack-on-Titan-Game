...
public class DataLoader {
	...
	public static HashMap<Integer, TitanRegistry> readTitanRegistry() throws IOException {
		// code, baseHealth, baseDamage, heightInMeters, speed, resourcesValue, dangerLevel.
		BufferedReader br = new BufferedReader(new FileReader(TITANS_FILE_NAME));
		HashMap<Integer, TitanRegistry> AllTitans = new HashMap<>();
		String line;
		while ((line = br.readLine()) != null) {
			...
			TitanRegistry tr = new TitanRegistry(code, baseHealth, baseDamage, heightInMeters, speed, resourcesValue, dangerLevel);
	...
	public static HashMap<Integer, WeaponRegistry> readWeaponRegistry() throws IOException {
		// {code, price, damage, name} // or //{code,price, damage, name, minRange, maxRange}
		BufferedReader br = new BufferedReader(new FileReader(WEAPONS_FILE_NAME));
		HashMap<Integer, WeaponRegistry> AllWeapons = new HashMap<>();
		String line;
		while ((line = br.readLine()) != null) {
			String[] data = line.split(",");
			int code = Integer.parseInt(data[0]);
